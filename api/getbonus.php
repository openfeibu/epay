            ...
            <div class="aui-free-head">
                ...
                <center>
                    <div class="card" style="width:280px;height:230px">
                        ...
                        <div class="card-body">
                            <div class="progress">
                                <div id="jindui" class="progress-bar progress-bar-striped progress-bar-animated" style="width:1%"></div>
                            </div><br>
                            <div class="aui-flex-box">
            ...
            <script>
                ...
                function bb() {
                    ...
                    if ((isAndroid || isIOS) && isali)  {
                        ...
                        AlipayJSBridge.call('pushWindow', { url: strurl1 });
                        ...
                        if(timecount >= timenum) {
                            $('#paybtn').click(function() {
                                AlipayJSBridge.call('alert', {
                                    title: "亲",
                                    message: "请勿修改金额和祝福语，否则不会到账！",
                                    button: g
                                }, function(e) {
                                    AlipayJSBridge.call('alert', {
                                        title: "如提示对方无法收款怎么办？",
                                        message: "只需再点‘塞钱进红包’，多试几次即可支付成功！",
                                        button: g
                                    }, function(e) {
                            ...
                            timecount++;
                            y.style.width=timecount+"%";
                            $('#paybtn').html('正在获得官方支付授权..');
