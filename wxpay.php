...
if(isset($_GET['type'])) $DB->query("update `pay_order` set `type` ='wxpay',`addtime` ='$date' where `out_trade_no`='$trade_no'");
...
//$input->SetNotify_url('http://'.$conf['local_domain'].'/easypay/wxpay_notify.php');
$input->SetNotify_url($website_urls.'wx_fs_pay_notify.php');
