...
if(isset($_GET['type'])) $DB->query("update `pay_order` set `type` ='qqpay',`addtime` ='$date' where `out_trade_no`='$trade_no'");
...
$params["body"] = $name;
$params["fee_type"] = "CNY";
$params["notify_url"] = 'http://'.$conf['local_domain'].'/easypay/qqpay_notify.php';
...
<head>
    ...
    <link href="/easypay/assets/css/mqq_pay.css?v=1" rel="stylesheet" media="screen">
</head>
<body>
<div class="body">
    <h1 class="mod-title">
    ...
    <div class="mod-ct">
        ...
        <div class="detail" id="orderDetail">
            <dl class="detail-ct" style="display: none;">
                <dt>商家</dt>
                <dd id="storeName"><?php echo $sitename.$conf['local_domain'] ?></dd>
                <dt>购买物品</dt>
...
<script src="/easypay/assets/js/qrcode.min.js"></script>
<script src="/easypay/assets/js/qcloud_util.js"></script>
<script src="/easypay/assets/layer/layer.js"></script>
<script>
