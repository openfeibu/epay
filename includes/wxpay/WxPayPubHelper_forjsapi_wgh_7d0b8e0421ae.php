...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		    ...
		    $this->returnParameters["total_fee"] = $this->returnParameters['total_fee'];//金额
		    $this->returnParameters["out_trade_no"] = $this->returnParameters['out_trade_no'];//商城订单号
		    $this->returnParameters["transaction_id"] = $this->returnParameters['transaction_id'];//支付订单号
		}
		return $this->arrayToXml($this->returnParameters);
	}
...
class JsApi_pub extends Common_util_pub
{
	...
	function createOauthUrlForCode($redirectUrl)
	{
		...
		$urlObj["state"] = $_REQUEST["RMB"]."`".$_REQUEST["orderid"]."`".$_REQUEST["des"]."`".$_REQUEST["token"];
