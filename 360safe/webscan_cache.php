...
//用户唯一key
define('WEBSCAN_U_KEY', $VERSION2.'6i639zAaC6k78R3unuD84H4DYi654Bb');
//数据回调统计地址
define('WEBSCAN_API_LOG', $website_urls.'api/post.php?key='.WEBSCAN_U_KEY);
//版本更新地址
define('WEBSCAN_UPDATE_FILE',$website_urls.'api/post.php?update=&key='.WEBSCAN_U_KEY);
//拦截开关(1为开启，0关闭)
$webscan_switch=1;
