            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                class="glyphicon glyphicon-cloud"></span> 代理结算<b class="caret"></b></a>
                    <ul class="dropdown-menu">

                        <li><a href="./slist.php">结算记录</a>
                        <li>
                    </ul>
                </li>
...
for (i = 0; i < items.length; i++) {
	$(items[i]).val($(items[i]).attr("default"));
            ...
            if($user == NULL or $pwd == NULL){
                ...
                if($DB->exec($sql) || $sqs) showmsg('修改合作者身份信息成功！<br/><br/><a href="./plist.php">>>返回合作者列表</a>',1);else
            ...
            if($DB->exec($sql)) showmsg('删除合作者成功！<br/><br/><a href="./plist.php">>>返回合作者列表</a>',1);else
  ...
  <button type="submit" class="btn btn-primary">搜索</button>&nbsp;<a href="./plist.php?my=add" class="btn btn-success">添加商户</a>&nbsp;<a href="./ulist.php" class="btn btn-default">普通商户管理</a>
            ...
            for($i = 1; $i < $page; $i++) echo '<li><a href="plist.php?page='.$i.$link.'">'.$i.'</a></li>';
            echo '<li class="disabled"><a>'.$page.'</a></li>';
            for($i = $page + 1; $i <= $pages; $i++) echo '<li><a href="plist.php?page='.$i.$link.'">'.$i.'</a></li>';
            echo '';
            if($page < $pages){
