    ...
    <div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                if(isset($_GET['creat'])){
                    ...
                    <form action="alipayapi.php" method="get" role="form">
                        <input type="hidden" name="batch" value="<?php echo $batch ?>"/>
                        <input type="hidden" name="allmoney" value="<?php echo $allmoney ?>"/>
                        <p><input type="text" name="batch2" value="" placeholder="自定义批次号（如果不需要自定义请留空）"
            ...
            <div class="panel-footer">
                <span class="glyphicon glyphicon-info-sign"></span> 结算标准：金额大于<?php echo $conf['settle_money'] ?>
                元，或主动申请的（需扣除手续费<?php echo $conf['settle_fee'] ?>元）<br/>
