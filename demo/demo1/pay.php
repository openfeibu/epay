...
<div class="body">
    <h1 class="mod-title">
        <span class="ico_log <?php if(@$_REQUEST['type']=='1'){ echo 'ico-3';}else { echo 'ico-1';} ?>"></span>
    </h1>
...
<!--			<a href="--><?php //echo @$_REQUEST['pay_url']; ?><!--" id="alipaybtn" class="btn btn-primary" target="_blank">启动支付宝App支付</a>-->
			<a href="<?php echo @$_REQUEST['pay_url']; ?>" id="alipaybtn" class="btn btn-primary" target="_self">启动支付宝App支付</a>
        </div>
...
<!--                    <img id="show_qrcode" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=--><?php //echo @$_REQUEST['pay_url']; ?><!--" width="300" height="210" style="display: block; width: 310px; height: 270px;">-->
                    <br />
                    <div id="show_qrcode" style=""><div id="qrcode"></div></div>
                    <script>
                        var qrcode = new QRCode("qrcode", {
                            text: "<?php echo @$_REQUEST['pay_url'] ?>",
                            width: 230,
                            height: 230,
                            colorDark: "#000000",
                            colorLight: "#ffffff",
                    ...
                    <img onclick="$(&#39;#use&#39;).hide()" id="use" src="<?php if(@$_REQUEST['type']=='1'){ echo 'Images/logo_weixin.png';}else { echo 'Images/logo_alipay.png';} ?>" style="position: absolute;top: 50%;left: 50%;width:32px;height:32px;margin-left: -16px;margin-top: -30px">
        ...
        <div class="payweixinbtn" style="display: none;">
			<a href="https://pan.baidu.com/share/qrcode?w=210&amp;h=210&amp;url=<?php echo @$_REQUEST['pay_url']; ?>" target="_blank" download="" id="downloadbtn" class="btn btn-primary">1.先保存二维码到手机</a>
		</div>
        ...
        <div class="time-item" style="padding-top: 10px">
            <div class="time-item" id="msg"><h1>付款即时到账，未到账可联系我们。<br><span style="color: red">请注意 每次扫码充值都要重新点击我要充值，该二维码只能使用一次。</span></h1> </div>
        ...
        <div class="tip">
            ...
            <div class="tip-text">
                <p id="showtext">打开<?php if(@$_REQUEST['type']=='1'){ echo '微信';}else { echo '支付宝';} ?> [扫一扫]</p>
            </div>
        </div>
        <div class="tip-text">
        </div>
...
<script type="text/javascript">
    ...
    function checkdata(){
		var no = $("#trade_no").val();
        $.post(
			"getresult.php?userid=<?php echo $_REQUEST['userid'] ?>",
            {
                trade_no : no,
            },
            function(data){
