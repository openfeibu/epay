...
if(isset($_REQUEST['userid']) && $_REQUEST['userid'] != ''){
    ...
    $userid = \epay\daddslashes($_REQUEST['userid']);
    //require_once __DIR__."/../../../includes/common.php";
    //require_once __DIR__."/../../../person_api/function.php";
    $user = \epay\user::find_user($userid);
    $alert = "<span style='color: red;'>商户ID（{$userid}）不存在，请重试或联系我们，谢谢！</span>";
}
if(!$user){
    print <<< EOF
    <!DOCTYPE html>
            ...
            <td>
                <label>
                    <div style="width: 80px;">
                        <input type="text" id="pid" name="pid" value="<?php echo $userid ?>" disabled>
                    </div>
                </label>
            </td>
        </tr>
